...
Return exactly one JSON object and no prose or markdown. A completed response has keys status="complete", assessments, and observations. Each assessment must use a supplied candidate_id, cite one or more supplied evidence_ids, give concise technical_explanation, layman_explanation, developer_action, and exact supplied locations. Use developer_action="none" when no change is warranted. Each optional observation has related_candidate_ids, evidence_ids, disposition, impact, exploitability, confidence, recommended_risk, title, technical_explanation, layman_explanation, developer_action, and exact supplied locations. Do not add an observation ID; TavernKeeper assigns it deterministically after validation.
